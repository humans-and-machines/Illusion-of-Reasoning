...
SCRIPT_PATH="${SCRIPT_PATH:-$PROJECT_ROOT/crossword-inference.py}"
MODEL_ROOT="${MODEL_ROOT:-$PROJECT_ROOT/data/Qwen2.5-1.5B-Open-R1-GRPO-Crosswords-v07}"
...
OUTPUT_ROOT="$PROJECT_ROOT/results/GRPO-1.5B-xword-temp-${TEMP}"
