...
PACKAGE_NAME = "open-r1"

# Remove stale egg-info directory to avoid https://github.com/pypa/pip/issues/5466
egg_info_dir = Path(__file__).parent / f"{PACKAGE_NAME.replace('-', '_')}.egg-info"
if egg_info_dir.exists():
    print(
        (
            "Warning: {} exists.\n\n"
            "If you recently updated {}, this is expected,\n"
            "but it may prevent {} from installing in editable mode.\n\n"
            "This directory is automatically generated by Python's packaging tools.\n"
            "I will remove it now.\n\n"
            "See https://github.com/pypa/pip/issues/5466 for details.\n"
        ).format(egg_info_dir, PACKAGE_NAME, PACKAGE_NAME)
    )
