...
class PassAggregate:
    ...
    :param _state: Internal mutable state dictionary used to accumulate metrics.
    """
    ...
    def __post_init__(self) -> None:
        """
        Initialize internal aggregation state for counts, entropies, tokens, and stops.

        :returns: ``None``. State is set up in-place.
        """
    ...
    def _counts(self) -> Dict[str, int]:
        """
        Internal counter dictionary for sample-level metrics.

        :returns: Mapping with keys such as ``\"n_samples\"`` and ``\"sample_correct\"``.
        """
    ...
    def _entropies(self) -> Dict[str, List[Optional[float]]]:
        """
        Internal entropy storage for different segments.

        :returns: Mapping with keys ``\"all\"``, ``\"think\"``, and ``\"answer\"``.
        """
    ...
    def _tokens(self) -> Dict[str, List[Optional[int]]]:
        """
        Internal token-count storage for different segments.

        :returns: Mapping with keys ``\"think\"`` and ``\"answer\"``.
        """
    ...
    def n_samples(self) -> int:
        ...
        :returns: Integer count of samples seen.
        """
    ...
    def n_samples(self, value: int) -> None:
        """
        Set the total number of accumulated samples.

        :param value: New sample count.
        :returns: ``None``.
        """
    ...
    def sample_correct(self) -> int:
        ...
        :returns: Count of samples with correct predictions.
        """
    ...
    def sample_correct(self, value: int) -> None:
        """
        Set the number of correctly predicted samples.

        :param value: New correct-sample count.
        :returns: ``None``.
        """
    ...
    def sample_improved(self) -> int:
        ...
        :returns: Count of samples where pass 2 improved over pass 1.
        """
    ...
    def sample_improved(self, value: int) -> None:
        """
        Set the number of samples marked as improved over pass 1.

        :param value: New improved-sample count.
        :returns: ``None``.
        """
    ...
    def tag_ok(self) -> int:
        ...
        :returns: Count of samples where tag structure checks passed.
        """
    ...
    def tag_ok(self, value: int) -> None:
        """
        Set the number of samples with valid tag structure.

        :param value: New count of tag-valid samples.
        :returns: ``None``.
        """
    ...
    def reconsider_numer(self) -> int:
        ...
        :returns: Count of samples where reconsideration markers were detected.
        """
    ...
    def reconsider_numer(self, value: int) -> None:
        """
        Set the number of samples containing reconsideration markers.

        :param value: New reconsideration count.
        :returns: ``None``.
        """
...
# Build __all__ dynamically so static analysis does not flag exports if this
# module is imported in constrained environments or partially executed.
__all__ = [name for name in _PUBLIC_EXPORTS if name in globals()]
