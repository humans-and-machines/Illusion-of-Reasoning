...
export CONFIG="recipes/Qwen2.5-7B-Instruct/grpo/config_math.yaml"
...
export RUN_NAME="Qwen7B-GRPO-Finetune"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
export CONFIG="recipes/Qwen2.5-7B-Instruct/grpo/config_math.yaml"
export CONFIG_FILE="recipes/accelerate_configs/zero3.yaml"
export SERVER_LOG="logs/liv_vllm_${RUN_NAME}_${TIMESTAMP}.log"
...
export RESUME_CKPT="${RESUME_CKPT:-$PROJECT_ROOT/models/open-r1/Qwen2.5-7B-Open-R1-GRPO-math-7b/checkpoint-500}"
