...
#SBATCH --partition=mltheory        # ← use the mltheory partition
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
...
# (optional) don’t pick the older engine via xformers if you don’t need it
...
echo '🚀 Launching training on GPU(s):' \$CUDA_VISIBLE_DEVICES
